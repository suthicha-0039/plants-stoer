...
// const BASE_URL = "https://script.google.com/macros/s/AKfycbxeG2w-NCSL0gfIKF-YNQufSujgVUPt1tjcWvnxc_0LfJ6b42eRy2TVratiSi4kdeuCPw/exec?sheetName=items"
  const BASE_URL = process.env.NEXT_PUBLIC_WEB_APP_URL+"https://script.google.com/macros/s/AKfycbxeG2w-NCSL0gfIKF-YNQufSujgVUPt1tjcWvnxc_0LfJ6b42eRy2TVratiSi4kdeuCPw?sheetName=items";
interface Product {
  pid: string;
  name: string;
  genre: string;
